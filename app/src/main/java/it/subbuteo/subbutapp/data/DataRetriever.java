...
public class DataRetriever implements VolleyResponseListener {
    ...
    public static final String AUTOGOAL = "AUTOGOAL";
        ...
        try{
            ...
            for(int i = 0; i < dayArr.length(); i++) {
                ...
                for(int j = 0; j < matchesArr.length(); j++){
                    ...
                    md.setRes1(Integer.valueOf(mtch.get(res.getString(R.string.left_res_tag)).toString()));
                    md.setPl2(mtch.get(res.getString(R.string.right_player_tag)).toString());
                    md.setRes2(Integer.valueOf(mtch.get(res.getString(R.string.right_res_tag)).toString()));
                    md.setLive1(Integer.valueOf(mtch.get(res.getString(R.string.live1_tag)).toString()));
                    ...
                    for(int k = 0; k < details.length(); k++){
                        ...
                        for(int kk = 0; kk < goals.length(); kk++){
                            ...
                            did.setMin(Integer.valueOf(goalsObj.get(res.getString(R.string.min_tag)).toString()));
                            did.setPlayer(Integer.valueOf(goalsObj.get(res.getString(R.string.player_tag)).toString()));
                        ...
                        for(int kk = 0; kk < cards.length(); kk++){
                            ...
                            DetailsItemData did = new DetailsItemData();
                            did.setMin(Integer.valueOf(cardsObj.get(res.getString(R.string.min_tag)).toString()));
                            did.setPlayer(Integer.valueOf(cardsObj.get(res.getString(R.string.player_tag)).toString()));
            ...
            for(int i = 0; i < leagueArr.length(); i++) {
                ...
                for(int j = 0; j < matchesArr.length(); j++){
                    ...
                    md.setLive1(Integer.valueOf(mtch.get(res.getString(R.string.live1_tag)).toString()));
                    try{
                        md.setRes3(Integer.valueOf(mtch.get(res.getString(R.string.left_res_second_tag)).toString()));
                        md.setRes4(Integer.valueOf(mtch.get(res.getString(R.string.right_res_second_tag)).toString()));
                        md.setLive2(Integer.valueOf(mtch.get(res.getString(R.string.live2_tag)).toString()));
                    }catch(Exception e){
