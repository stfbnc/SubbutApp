...
public class HallOfFameCup extends UpdatableFragment {

    private RecyclerView.Adapter adapter;
    private ArrayList<HallOfFameData> lst = new ArrayList<>();

    public HallOfFameCup() {}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.hall_of_fame_cup, container, false);
        RecyclerView recyclerView = v.findViewById(R.id.recycle_ranking);
        recyclerView.setHasFixedSize(true);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getActivity());
        recyclerView.setLayoutManager(layoutManager);
        getList();
        adapter = new HallOfFameCupAdapter(lst);
        recyclerView.setAdapter(adapter);

        final SwipeRefreshLayout pullToRefresh = v.findViewById(R.id.pullToRefreshRankingHalloffameCup);
    ...
    private void getList(){
        RankHOFCup rankMtx = new RankHOFCup(getActivity());
