...
public class HallOfFameLeagueAdapter extends RecyclerView.Adapter<HallOfFameLeagueAdapter.ViewHolder> {
    ...
    public HallOfFameLeagueAdapter(ArrayList<HallOfFameData> lst) {
        mList = lst;
    }

    @Override
    public HallOfFameLeagueAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        View match_row = inflater.inflate(R.layout.ranking_row, parent, false);
        HallOfFameLeagueAdapter.ViewHolder viewHolder = new HallOfFameLeagueAdapter.ViewHolder(match_row);
        return viewHolder;
    }
