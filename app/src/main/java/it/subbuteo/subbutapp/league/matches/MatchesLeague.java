package it.subbuteo.subbutapp.league.matches;
...
public class MatchesLeague extends UpdatableFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.matches_league, container, false);
        ...
        qDate.setText(Objects.requireNonNull(DataRetriever.dataHashMapLeague.get(getString(R.string.quarters))).getDate());
        ...
        getqList();
        qAdapter = new MatchesLeagueAdapter(qList, false);
        ...
        recyclerView_q.addOnItemTouchListener(new RecyclerItemClickListener(getActivity(), new RecyclerItemClickListener.OnItemClickListener() {
            @Override public void onItemClick(View view, int position) {
                openDetailsFragment(position, qList, false);
            }
        }));
        ...
        sDate.setText(Objects.requireNonNull(DataRetriever.dataHashMapLeague.get(getString(R.string.semifinals))).getDate());
        ...
        getsList();
        sAdapter = new MatchesLeagueAdapter(sList, false);
        ...
        ffDate.setText(Objects.requireNonNull(DataRetriever.dataHashMapLeague.get(getString(R.string.first_final))).getDate());
        ...
        getffList();
        ffAdapter = new MatchesLeagueAdapter(ffList, true);
        ...
        final SwipeRefreshLayout pullToRefresh = v.findViewById(R.id.pullToRefreshMatchesLeague);
    ...
    private void openDetailsFragment(int pos, ArrayList<MatchData> list, boolean isSingleMatch){
        ...
        bndl.putInt(getString(R.string.bundle_competition_type_tag), Globals.CHAMPIONS_LEAGUE);
        MatchDetails mtchDet = new MatchDetails(getActivity(), bndl);
        mtchDet.showDetails();
    }

    private void getqList(){
        qList.addAll(Objects.requireNonNull(DataRetriever.dataHashMapLeague.get(getString(R.string.quarters))).getMatchData());
    }

    private void getsList(){
        sList.addAll(Objects.requireNonNull(DataRetriever.dataHashMapLeague.get(getString(R.string.semifinals))).getMatchData());
    }
    ...
    private void getffList(){
        ffList.addAll(Objects.requireNonNull(DataRetriever.dataHashMapLeague.get(getString(R.string.first_final))).getMatchData());
    }
