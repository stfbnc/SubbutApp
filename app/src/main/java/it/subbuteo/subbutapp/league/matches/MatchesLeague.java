...
public class MatchesLeague extends UpdatableFragment {
    ...
    private void getqList(){
        qList.addAll(DataRetriever.dataHashMapLeague.get(getString(R.string.quarters)).getMatchData());
    }

    private void getsList(){
        sList.addAll(DataRetriever.dataHashMapLeague.get(getString(R.string.semifinals)).getMatchData());
    }

    private void getffList(){
        ffList.addAll(DataRetriever.dataHashMapLeague.get(getString(R.string.first_final)).getMatchData());
    }
